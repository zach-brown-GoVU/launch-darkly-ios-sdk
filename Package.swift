...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "LDDataCompression", url: "https://github.com/zach-brown-GoVU/LDDataCompression.git", .branch("master"))
    ],
    targets: [
        .target(
            name: "LaunchDarkly",
            dependencies: [
                ...
                .product(name: "LDDataCompression", package: "LDDataCompression")
            ],
